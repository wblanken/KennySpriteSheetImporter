...
def create_meta_file(out_file_name, sprites):
    ...
    for sprite in sprites:
        out_file.write(__create_sprite_meta_data(sprite))
...
metaFileText = [
    ...
    str('timeCreated: 1445387649' + __break),
    ...
    str(__tab + 'maxTextureSize: 204' + __break),
    str(__tab + 'textureSettings:' + __break),
    str(__tab + __tab + 'filterMode: -1'),
    str(__tab + __tab + 'aniso: 16'),
    str(__tab + __tab + 'mipBias: -1'),
    str(__tab + __tab + 'wrapMode: 1'),
